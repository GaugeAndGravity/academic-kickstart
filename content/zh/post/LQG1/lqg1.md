...
<img class=displaymath id="eqtsplit" style="margin-top:0.7em;margin-bottom:0" src="https://www.zhihu.com/equation?tex=t^a=Nn^a%2BN^a,\quad%20N>0,\quad%20n^a\in\mathrm{T}_p{{\mathcal{S}}_t},\\\\" alt="t^a=Nn^a+N^a"/>
