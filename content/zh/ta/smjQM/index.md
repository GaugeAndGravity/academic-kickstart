...
{{% alert warning %}}
**本学期期末成绩及所有作业成绩登记完毕，请所有人在 <a href="http://home.ustc.ude.cn/~wyj1234" target="_blank">home.ustc.edu.cn/~wyj1234</a> 及时查看**

**期末成绩及作业成绩有疑问的请在21号晚七点前找助教。21号晚七点所有数据将提交给石老师进行总评的计算。期末接受线上查卷，规则如下：和我(王英洁)私聊指定查卷题号，我们助教会重新仔细重新阅卷一遍所申请重阅的题目，但评分标准不会改，只改正误判，不改变阅卷松紧度，因此不保证会加分，有可能倒扣的哦~**
{{% /alert %}}
